...
int main(void)
{
	...
	PORTn_PCRx = PORT_PCR_MUX(1) | PORT_PCR_DSE_MASK;//CONTROL2!
	PORTn_PCRx = PORT_PCR_MUX(1) | PORT_PCR_DSE_MASK;//CONTROL3!
	PORTn_PCRx = PORT_PCR_MUX(1) | PORT_PCR_DSE_MASK;//CONTROL4!
	...
	GPIOC_PDDR |= LED_CONTROL2;
	GPIOC_PDDR |= LED_CONTROL3;
	GPIOC_PDDR |= LED_CONTROL4;
